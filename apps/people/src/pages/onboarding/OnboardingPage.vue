...
const pricingPlans: PricingPlan[] = [
  {
    ...
    monthlyPrice: 4999,
    yearlyPrice: 49990,
    features: ['Up to 25 employees', 'Basic payroll', 'Leave management']
  },
  {
    id: 'professional',
    name: 'Professional',
    ...
    yearlyPrice: 129990,
    featured: true,
    features: ['Up to 100 employees', 'Time tracking', 'Performance reviews']
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    ...
    monthlyPrice: 29999,
    yearlyPrice: 299990,
    features: ['Unlimited employees', 'Multi-country', 'Dedicated support']
  }
]
...
<template>
      ...
      <div class="space-y-3">
        ...
        >
          ...
          >
            <div class="flex items-center gap-3">
              <div
                ...
                :class="formData.selectedPlanId === plan.id ? 'border-indigo-500 bg-indigo-500' : 'border-gray-300'"
              >
              ...
              <div>
                <div class="flex items-center gap-2">
                  ...
                  <span v-if="plan.featured" class="rounded bg-indigo-100 px-1.5 py-0.5 text-[10px] font-medium text-indigo-700">Popular</span>
                </div>
          ...
          <div class="border-t border-gray-100 px-3 py-2">
            <button
              class="flex cursor-pointer items-center gap-1 text-xs text-indigo-600 hover:text-indigo-700"
  ...
  >
    <div v-if="drawerPlan" class="p-4">
      ...
      <div class="mb-6">
        <div class="flex items-center gap-2">
          <span v-if="drawerPlan.featured" class="rounded bg-indigo-100 px-2 py-0.5 text-xs font-medium text-indigo-700">Most Popular</span>
        </div>
      ...
      <div>
        ...
        <ul class="space-y-3">
          <li v-for="feature in drawerPlan.features" :key="feature" class="flex items-start gap-2">
            <svg class="mt-0.5 size-4 shrink-0 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
            </svg>
    ...
    <template #footer>
      <button
        class="w-full rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-indigo-700"
