...
onMounted(() => {
  fetchPlans('PRODUCT_HRMS', { description: '', features: [] })
})
      ...
      <div class="space-y-4">
        <div>
          ...
          <div v-if="tenantSubdomain || customSubdomain" class="mt-2">
            ...
            <div class="flex overflow-hidden rounded-lg border border-gray-300 hover:border-gray-400 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-100">
              <input
                :value="customSubdomain"
                type="text"
                placeholder="acme-corporation"
                class="w-0 min-w-0 flex-1 bg-white px-3 py-2 text-sm text-indigo-600 placeholder:text-xs placeholder:text-gray-400 focus:outline-none"
    ...
    <template v-else-if="currentStep?.id === 'verification'">
      <div class="space-y-5">
        <div class="text-center">
          <div class="mx-auto mb-3 flex size-12 items-center justify-center rounded-full bg-gradient-to-br from-indigo-50 to-indigo-100">
          ...
          <input
            ...
            :class="[
              otpError
                ...
                : otpDigits[i]
                  ? 'border-indigo-300 bg-indigo-50/30 text-gray-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-100'
                  : 'border-gray-200 bg-white text-gray-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-100'
            ]"
        ...
        <button
          ...
          :class="isOtpComplete && !isVerifying ? 'bg-indigo-600 hover:bg-indigo-700 shadow-sm' : 'bg-gray-300'"
        ...
        <div class="text-center">
          <p class="text-xs text-gray-400">
            ...
            <button
              ...
              :class="resendCountdown > 0 ? 'cursor-not-allowed text-gray-400' : 'text-indigo-600 hover:text-indigo-700'"
      ...
      <div class="space-y-6">
        ...
        <div v-else-if="provisioningFailed" class="space-y-5 py-4">
          ...
          <div class="flex justify-center pt-2">
            <a
              href="/onboarding"
              class="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white transition-all hover:bg-indigo-700"
            >
              Try again
            </a>
          </div>
            ...
            <div class="relative min-h-[44px] overflow-hidden">
              ...
              >
                <div
                  ...
                  class="flex items-center gap-3 rounded-lg bg-indigo-50/60 px-3 py-2.5"
                >
                  <div class="flex size-7 shrink-0 items-center justify-center rounded-full border-2 border-indigo-200 bg-white">
                    <svg class="size-4 animate-spin text-indigo-500" viewBox="0 0 24 24" fill="none">
                      <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" />
                      <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
                    </svg>
                  </div>
