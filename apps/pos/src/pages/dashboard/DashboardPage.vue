    ...
    <template v-if="activeSidebarId === 'overview'">
      ...
      <div class="mb-6 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        <div class="bg-gradient-to-r from-blue-600 to-blue-500 px-5 py-4">
          ...
          <p class="mt-0.5 text-xs text-blue-100">{{ user?.tenantName || 'My Business' }}</p>
        </div>
        <div class="flex items-center justify-between px-5 py-3">
          ...
          <a
            :href="dashboardUrl"
            class="inline-flex cursor-pointer items-center gap-1.5 rounded-lg bg-blue-600 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-blue-700"
          >
            Open
    ...
    <template v-else-if="activeSidebarId === 'workspace'">
      ...
      <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        <div class="bg-gradient-to-r from-blue-600 to-blue-500 px-5 py-4">
          ...
          <p class="mt-0.5 text-xs text-blue-100">{{ dashboardUrl }}</p>
        </div>
        <div class="px-5 py-3">
          <a
            :href="dashboardUrl"
