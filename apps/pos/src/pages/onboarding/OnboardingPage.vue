...
const steps: OnboardingStep[] = [
  ...
  },
  {
    ...
    description: 'Choose the billing cycle that fits your business',
    icon: 'credit-card',
    required: true,
    order: 3
  },
...
onMounted(() => {
  fetchPlans('PRODUCT_POS', { description: '', features: [] })
})
...
// Start resend countdown when entering verification step
...
watch(provisioningReady, (ready) => {
  if (ready) {
    // Stop rotating messages and typing
    if (messageTimer) {
      clearInterval(messageTimer)
      messageTimer = null
    }
  ...
  >
    ...
    <template v-else-if="currentStep?.id === 'organization'">
      <div class="space-y-4">
          ...
          <div v-if="tenantSubdomain || customSubdomain" class="mt-2">
            ...
            <div class="flex overflow-hidden rounded-lg border border-gray-300 hover:border-gray-400 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100">
              <input
                ...
                type="text"
                placeholder="my-retail-store"
                class="w-0 min-w-0 flex-1 bg-white px-3 py-2 text-sm text-blue-600 placeholder:text-xs placeholder:text-gray-400 focus:outline-none"
        ...
        />
        <div class="w-full">
          <label class="mb-1 block text-xs font-medium text-gray-600">Business Website</label>
          <div class="flex overflow-hidden rounded-lg border border-gray-300 hover:border-gray-400 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100">
    ...
    <template v-else-if="currentStep?.id === 'verification'">
      <div class="space-y-5">
        <!-- Compact header with animated envelope -->
        <div class="text-center">
          <div class="mx-auto mb-3 flex size-12 items-center justify-center rounded-full bg-gradient-to-br from-blue-50 to-blue-100">
        ...
        <!-- Compact OTP inputs with separator -->
          ...
          <input
            ...
            :class="[
              otpError
                ...
                : otpDigits[i]
                  ? 'border-blue-300 bg-blue-50/30 text-gray-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-100'
                  : 'border-gray-200 bg-white text-gray-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-100'
            ]"
        ...
        <button
          ...
          :class="isOtpComplete && !isVerifying ? 'bg-blue-600 hover:bg-blue-700 shadow-sm' : 'bg-gray-300'"
        ...
        <div class="text-center">
          <p class="text-xs text-gray-400">
            ...
            <button
              ...
              :class="resendCountdown > 0 ? 'cursor-not-allowed text-gray-400' : 'text-blue-600 hover:text-blue-700'"
      ...
      <div class="space-y-6">
        ...
        <div v-else-if="provisioningFailed" class="space-y-5 py-4">
          ...
          <div class="flex justify-center pt-2">
            <a
              href="/onboarding"
              class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white transition-all hover:bg-blue-700"
            >
              Try again
            </a>
          </div>
            ...
            <div class="relative min-h-[44px] overflow-hidden">
              ...
              >
                <div
                  ...
                  class="flex items-center gap-3 rounded-lg bg-blue-50/60 px-3 py-2.5"
                >
                  <div class="flex size-7 shrink-0 items-center justify-center rounded-full border-2 border-blue-200 bg-white">
