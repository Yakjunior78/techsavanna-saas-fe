      ...
      <div class="space-y-6">
        ...
        <div v-else-if="provisioningFailed" class="space-y-5 py-4">
          ...
          <div class="flex justify-center pt-2">
            <a
              href="/onboarding"
              class="inline-flex items-center gap-2 rounded-lg bg-amber-600 px-4 py-2.5 text-sm font-medium text-white transition-all hover:bg-amber-700"
            >
              Try again
            </a>
          </div>
            ...
            <div class="relative min-h-[44px] overflow-hidden">
              ...
              >
                <div
                  ...
                  class="flex items-center gap-3 rounded-lg bg-amber-50/60 px-3 py-2.5"
                >
                  <div class="flex size-7 shrink-0 items-center justify-center rounded-full border-2 border-amber-200 bg-white">
                    <svg class="size-4 animate-spin text-amber-500" viewBox="0 0 24 24" fill="none">
                      <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" />
                      <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
                    </svg>
                  </div>
